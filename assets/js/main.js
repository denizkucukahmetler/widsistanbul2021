...
!(function($) {
 ...
 $(document).ready(function() {
		...
		"en": {
			...
			"register" : "Regıster",
			"abo" : "<br /> <br /> <br /> <br /> WiDS Istanbul is a technical conference for aiming to inspire, educate and support women in data science. Organized for the first time by <a id='stanf_link' class='cta-btn' href='https://www.stanford.edu/' target='blank'> Stanford University </a> in 2015, it turned into a worldwide conference with 150+ regional events in more than 60 countries, reaching 100,000 participants annually online and in person. <br /> <br /> WiDS Istanbul, organized by WiDS Istanbul ambassadors and <a id='sabanci_link' class='cta-btn' href='https://www.sabanciuniv.edu/en/' target='blank'> Sabancı University </a> <a id='verim_link' class='cta-btn' href='https://verim.sabanciuniv.edu/en' target='blank'> VERIM</a> will be held online on March 7, 2021.  <br /> <br />  All genders are invited to attend WiDS events, which feature outstanding women doing outstanding work.",
			"amb": "Ambassadors",
