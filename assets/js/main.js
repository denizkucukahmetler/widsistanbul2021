...
!(function($) {
 ...
 $(document).ready(function() {
		...
		"en": {
			...
			"register" : "Regıster",
			"abo" : "<br /> <br />  <br /> <br /> <br /> <br /> <br /> WiDS Istanbul is an independent event organized by WiDS Istanbul ambassadors and <a id='sabanci_link' class='cta-btn' href='https://www.sabanciuniv.edu/en/' target='blank'> Sabancı University </a> <a id='verim_link' class='cta-btn' href='https://verim.sabanciuniv.edu/en' target='blank'> VERIM</a>. WiDS Istanbul will take place on March 7, 2021 and coincides with the annual <a id='wids_link' class='cta-btn' href='https://www.widsconference.org/' target='blank'>Women in Data Science (WiDS) Worldwide Conference</a> hosted by <a id='stanf_link' class='cta-btn' href='https://www.stanford.edu/' target='blank'> Stanford University  </a>   and an estimated 150+ locations worldwide. All genders are invited to attend WiDS events, which feature outstanding women doing outstanding work.",
			"amb": "Ambassadors",
      ...
      "aytulinfo": "Aytül Erçil, Professor; Partner and CEO, Vispera",
		...
		"tr": {
			...
			"register" : "Kayıt",
			"abo":"<br /> <br />  <br /> <br /> <br /> <br /> <br /> Veri Biliminde Kadınlar İstanbul, WiDS İstanbul elçileri ve <a id='sabanci_link' class='cta-btn' href='https://www.sabanciuniv.edu/tr/' target='blank'> Sabancı Üniversitesi </a> <a id='verim_link' class='cta-btn' href='https://verim.sabanciuniv.edu/' target='blank'> VERİM </a>  tarafından düzenlenen bağımsız bir etkinliktir. WiDS İstanbul, 7 Mart 2021 tarihinde <a id='stanf_link' class='cta-btn' href='https://www.stanford.edu/' target='blank'> Stanford Üniversitesi  </a>  de dahil olmak üzere dünya çapında 150'den fazla lokasyonda düzenlenen <a id='wids_link' class='cta-btn' href='https://www.widsconference.org/' target='blank'> Women in Data Science (WiDS) Konferansı  </a> ile aynı anda gerçekleşecektir. Tüm cinsiyetler, harika işler yapan harika kadınların yer aldığı WiDS etkinliklerine davetlidir.",
      "amb": "Ambassadors", 
			"amb": "Temsilci",
